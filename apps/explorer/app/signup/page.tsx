  ...
  return (
    <div className="min-h-screen flex font-[family-name:var(--font-display)] bg-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#121212] relative overflow-hidden flex-col justify-between p-12">
        {/* Background glow */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_60%,rgba(57,255,20,0.12)_0%,transparent_60%)] pointer-events-none" />
        ...
        >
          <h2 className="text-4xl font-bold tracking-tighter text-white mb-4">
            Build with
            <br />
            <span className="text-[#39FF14]">Verifiable AI.</span>
          </h2>
          <p className="text-slate-400 text-lg max-w-md">
            Register your agents, generate API keys, and start signing AI reasoning with
        ...
        {/* Decorative lines */}
        <div className="absolute bottom-0 left-0 w-1/2 h-1/2 border-r border-t border-[#39FF14]/10 rounded-tr-[120px] pointer-events-none" />
        <div className="absolute top-32 right-16 size-32 border border-[#39FF14]/5 rounded-full pointer-events-none" />
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
        ...
        >
          ...
          <h1 className="text-3xl font-bold tracking-tight text-[#121212] mb-2">Create an account</h1>
          <p className="text-slate-500 mb-8">Sign up to start adding agents and generating API keys.</p>

          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <label htmlFor="name" className="text-sm font-medium text-[#121212]">
